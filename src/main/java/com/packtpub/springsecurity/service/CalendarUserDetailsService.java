...
/**
 * Integrates with Spring Security using our existing {@link CalendarUserDao} by
 * looking up a {@link CalendarUser} and
...
public class CalendarUserDetailsService implements UserDetailsService {
    ...
    /**
     * Lookup a {@link CalendarUser} by the username representing the email address.
     * Then, convert the
     * {@link CalendarUser} into a {@link UserDetails} to conform to the
    ...
    /**
     * There are advantages to creating a class that extends {@link CalendarUser},
     * our domain notion of a user, and
     * implements {@link UserDetails}, Spring Security's notion of a user.
     * <ul>
     * <li>First we can obtain all the custom information in the
     * {@link CalendarUser}</li>
     * <li>Second, we can use this service to integrate with Spring Security in
     * other ways (i.e. when implementing
     * Spring Security's <a
     * href=
     * "http://static.springsource.org/spring-security/site/docs/3.1.x/reference/remember-me.html">Remember-Me
     * Authentication</a></li>
     * </ul>
     *
     * @author bnasslahsen
